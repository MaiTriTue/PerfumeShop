...
const PublicRoutes = [
    ...
    { path: '/thuong-hieu-hot', component: HotBrand, Layout: null },
    { path: '/pages/tin-tuc', component: BeautyManual, Layout: null },
    { path: '/pages/sale-month', component: MonthlyProgram, Layout: null },
